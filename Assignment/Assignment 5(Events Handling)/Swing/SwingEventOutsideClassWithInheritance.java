...
class SwingEventOutsideClassWithInheritance extends JFrame
{
	...
	JButton button3;
	JButton button4;
	SwingEventOutsideClassWithInheritance()
	{
	...
	{
		new SwingEventOutsideClassWithInheritance();
	}
...
{
	SwingEventOutsideClassWithInheritance obj;
	public OutsideClass(SwingEventOutsideClassWithInheritance obj)
	{
		this.obj = obj;
	}
