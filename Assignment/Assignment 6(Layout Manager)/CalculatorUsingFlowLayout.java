...
class CalculatorUsingFlowLayout extends JFrame implements ActionListener
{
	...
	CalculatorUsingFlowLayout()
	{
		...
		setLayout(new FlowLayout(FlowLayout.CENTER,100,125));
		setVisible(true);
	}
	public static void main(String[] args)
	{
		new CalculatorUsingFlowLayout();
	}
